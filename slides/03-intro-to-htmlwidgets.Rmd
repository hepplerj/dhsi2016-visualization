...
An R package for integrating JavaScript libraries into R visualizations. Visualizations can appear in RMarkdown documents, RStudio, or Shiny web applications (more on this tomorrow).
...
```{r}
da#install.packages("networkD3")
library(networkD3)
ta(MisLinks, MisNodes)
MisLinks %>% head(5)
MisNodes %>% head(5)
```
